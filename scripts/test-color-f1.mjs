...
for(const name of ['color_f1_test','color_f1_host_test','indexed_ram2_source_test','mpe_video_live_test','mpe_video_crop_test','mpe_video_detail_test','mpe_video_sprite_test','indexed_host_test','full_video_converter_test','full_video_host_test']){
